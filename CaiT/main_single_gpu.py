...
def main():
    ...
    # Predict
    if config.PREDICT:
        result = predict(dataloader_test, model)
        print(result)
        return
...
if __name__ == "__main__":
    if not os.path.exists("data/LSVRC2012/train_list.txt"):
        shutil.copy("data/LSVRC2012/3train_list_shuffle_cut2.txt","data/LSVRC2012/train_list.txt")
        shutil.copy("data/LSVRC2012/3valid_list_shuffle_cut2.txt","data/LSVRC2012/val_list.txt")
    main()
